...
<xsl:template match="/atom:feed">
	...
	<meta property="og:site_name" content="Vegan Cuisine">
...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-tree"> Vegan Cuisine</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/design/">Bolos</a>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="Vegan Cuisine – Rezepte von Edgar und Anna">
ANANANAANANANA
				<img src="http://localhost:4000/assets/img/logo.png" alt="Vegan Cuisine – Rezepte von Edgar und Anna">
			</a>
